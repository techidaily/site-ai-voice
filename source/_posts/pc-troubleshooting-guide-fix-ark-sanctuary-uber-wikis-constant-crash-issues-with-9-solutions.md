---
title: "PC Troubleshooting Guide: Fix ARK: Sanctuary Über Wiki's Constant Crash Issues with 9 Solutions"
date: 2024-11-05T20:38:40.439Z
updated: 2024-11-06T23:34:07.644Z
tags:
  - win11
  - win10
  - win7
categories:
  - ProgramIssues
description: "This Article Describes PC Troubleshooting Guide: Fix ARK: Sanctuary Über Wiki's Constant Crash Issues with 9 Solutions"
excerpt: "This Article Describes PC Troubleshooting Guide: Fix ARK: Sanctuary Über Wiki's Constant Crash Issues with 9 Solutions"
thumbnail: https://thmb.techidaily.com/d0b73eb28e24a2f2ed6215d7e2c211efc75eaeb77baea06879d148a0fe930510.jpg
---

## Century: Age of Ashes PC Version Troubleshooting – Fix Constant Crash Issues
...
| **Processor:**      | Intel Core i5 2.6Ghz or AMD FX-8350  | Intel Core i7 2.8Ghz or AMD Ryzen 5 3.2Ghz |
| **Memory:**         | 6 GB RAM                             | 8 GB RAM                                   |
| **Graphics:**       | NVIDIA GTX 760 or AMD RX 560         | NVIDIA GTX 970 or AMD RX 580               |
...
1. On your keybaord, press**the Windows logo key** and**I** at the same time to open**Windows Settings** .
2. Click**Gaming** and go to**Game Bar** . Then turn off **Record game clips, screenshots, and broadcast using Game bar** option.

**To disable Nvidia GeForce Experience Overlay:**

1. Launch the Nvidia GeForce Experience app and go to**Settings** .
2. Click on the**General** tab, then**disable** the**In-Game Overlay** option.
3. Restart Windows to apply changes.
...
2. Launch Fortect. You’ll be asked to run a free scan of your computer. Click **Yes** to continue.
...
**Restart** Windows OS and launch Century: Age of Ashes to check if the game crashes again. If not, open the **System Configuration** window again to enable services and applications **one by one** until you find the problematic software.
 ...
 Once you find out the problematic software that crashes Century: Age of Ashes, you can **uninstall** it to avoid game crashing issues in the future.

 If the crashing issue reappears after you disabled all the 3rd party apps and services, try reinstalling Century: Age of Ashes.

 Normally, after reinstalling the game, you’ll be able to fix the crashing issue.

**Tips:**

 If these common fixes didn’t help you fix the Century: Age of Ashes crashing issue, you can also try investigating Windows crash logs to analyze and troubleshoot the causes of the crash. For more details, see the article: [How to view crash logs in Windows 10](https://www.supereasy.com/how-to-view-crash-logs-in-windows-10/) .

---

 Hopefully, one of the fixes above helped you fix the Century: Age of Ashes crashing issue. If you have any questions or suggestions on this issue, feel free to leave us a comment below. Thanks for reading!
...
<li><a href="https://fox-helps.techidaily.com/updated-navigating-video-streaming-tools-a-focus-on-zoom-with-youtube-for-2024/"><u>[Updated] Navigating Video Streaming Tools A Focus on Zoom with YouTube for 2024</u></a></li>
